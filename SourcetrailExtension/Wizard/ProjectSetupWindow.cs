			...
			if (_onCreateProject != null)
			{
				...
				if(Directory.Exists(targetDir) && CheckFileNameIsValid(textBoxFileName.Text))
				{
					if (CheckFileExists())
					{
						...
						DialogResult result = MessageBox.Show("A file of the chosen name already exists. Do you want to replace it?", "Sourcetrail Extension", MessageBoxButtons.YesNo, MessageBoxIcon.Warning);
				...
				else
				{
					if(Directory.Exists(targetDir) == false)
					{
						...
						MessageBox.Show("The target directory does not exist.", "Sourcetrail Extension", MessageBoxButtons.OK, MessageBoxIcon.Warning);
					}
					...
					if (CheckFileNameIsValid(textBoxFileName.Text) == false)
					{
						...
						MessageBox.Show("The chosen file name is not valid.", "Sourcetrail Extension", MessageBoxButtons.OK, MessageBoxIcon.Warning);
					}
				}
			}
			else
